...
def play_game(chosen_number, attempts):
    ...
    while attempts > 0:
        ...
        if guess == chosen_number:
            ...
            print("Guess again.")
            print(f"You have {attempts} attempts remaining to guess the number.") if attempts > 0 else print(f"You've run out of guesses, you lose. The answer was {chosen_number}.")
