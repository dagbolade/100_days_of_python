...
def main():
    ...
    print("Get ready for a thrilling gaming adventure where you can play Blackjack ♠️♦️ and guess numbers 1️⃣2️⃣3️⃣.")
    print("Challenge yourself, place bets, and see if luck is on your side.")
