...
if left_or_right == "left":
    ...
    if swim_or_wait == "wait":
        red_blue_yellow = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose? ").lower()
